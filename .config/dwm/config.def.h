...
static const char col_bg1[]         = "#2b2d3f";
static const char col_bg2[]         = "#2b2d3f";
static const char col_text1[]       = "#725cad";
static const char col_text2[]       = "#2b2d3f";
static const char col_main[]        = "#725cad";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_text1, col_bg1,   col_bg2 },
	[SchemeSel]  = { col_text2, col_main,  col_main  },
};
...
static const Rule rules[] = {
	...
	{ "floorp",         NULL,       NULL,       1 << 0,       0,           -1 },
	{ "AyuGramDesktop", NULL,       NULL,       1 << 1,       0,           -1 },
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_t,      spawn,          {.v = ayugram } },
  ...
  { MODKEY|ShiftMask,             XK_s,      spawn,          {.v = flameshot} },
	...
	{ 0, XF86XK_AudioMute,                     spawn,          SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 0") },
